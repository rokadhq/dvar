export const DVAR_POLICY_SCHEMA = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://dvar.rokad.co/schema/policy-v1.json",
  title: "Dvar policy schema v1",
  type: "object",
  additionalProperties: false,
  required: ["schemaVersion", "mode", "defaultEffect"],
  properties: {
    schemaVersion: { const: "1" },
    version: { type: "string", minLength: 1, maxLength: 128 },
    mode: { enum: ["off", "monitor", "enforce", "strict"] },
    defaultEffect: { enum: ["allow", "deny", "require_approval"] },
    runtime: {
      type: "object",
      additionalProperties: false,
      properties: {
        onEvaluationError: { enum: ["allow", "deny"] },
        onDecisionTimeout: { enum: ["allow", "deny"] },
  ...
  $defs: {
    matcher: {
      ...
      properties: {
        ...
        equalsContext: { type: "string", minLength: 1 }
      }
    },
    matchValue: {
      anyOf: [
    ...
    rule: {
      ...
      properties: {
        ...
        constraints: { $ref: "#/$defs/matchRecord" },
